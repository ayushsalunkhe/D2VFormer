...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./visualizations', help='Directory for model visualization outputs')
    parser.add_argument('--mark_index', type=int, nargs='+', default=[0, 1, 2, 3], help='Indices of timestamp features fed to Date2Vec (0-3 = hour, weekday, day, month)')
